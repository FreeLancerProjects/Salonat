...
import com.semicolon.salonat.adapters.ServiceInSalonAdapter;
...
public class Fragment_Service_In_Salon extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_service_in_salon,container,false);
        initView(view);
    ...
    public static Fragment_Service_In_Salon getInstance(SalonModel salonModel)
    {
        Bundle bundle = new Bundle();
        bundle.putSerializable(TAG,salonModel);
        Fragment_Service_In_Salon fragment_service_in_salon = new Fragment_Service_In_Salon();
        fragment_service_in_salon.setArguments(bundle);
        return fragment_service_in_salon;
    }
    ...
    private void getAllService(String id_salon) {
        Api.getService()
                .getServices(id_salon, Tags.in_salon)
    ...
    private void UpdateAdapterData(List<ServiceModel> serviceModelList) {
        ...
        adapter = new ServiceInSalonAdapter(groupModelList,getActivity(),this);
    ...
    public void AddItem(ServiceModel.Sub_Service subService)
    {
        ...
        homeActivity.AddItemInSalon(subService,salonModel);
        /*if (itemModel==null)
        {
...
*/
    ...
    public void RemoveItem(ServiceModel.Sub_Service subService)
    {
        ...
        homeActivity.RemoveItemInSalon(subService);
        /*if (itemModel!=null)
        {
