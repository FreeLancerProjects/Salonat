...
public class Fragment_Vote_In_Home extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_vote_in_home,container,false);
        initView(view);
        return view;
    }

    public static Fragment_Vote_In_Home getInstance(SalonModel salonModel)
    {
        Bundle bundle = new Bundle();
        bundle.putSerializable(TAG,salonModel);
        Fragment_Vote_In_Home fragment_vote_in_home = new Fragment_Vote_In_Home();
        fragment_vote_in_home.setArguments(bundle);
        return fragment_vote_in_home;
    }
    ...
    private void getVotes(String id_salon) {
        Api.getService()
                .getClientsVotes(id_salon, Tags.in_home)
